...
class InvoiceRequest(BaseModel):
    ...
    client_postal_code: Optional[str] = Field(None, description="請求先郵便番号")
    client_address: Optional[str] = Field(None, description="請求先住所")
    client_contact_person: Optional[str] = Field(None, description="請求先担当者名")
    issuer_name: str = Field(..., description="発行者名")
    issuer_postal_code: Optional[str] = Field(None, description="発行者郵便番号")
